...
import com.kerolos.newspaper.data.dto.*;
...
public class AuthenticationController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "Invalid input or authentication failed",
                    content = @Content(mediaType = "application/json")),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Logout successful",
                    content = @Content(mediaType = "application/json")),
            @ApiResponse(responseCode = "400", description = "Logout attempt failed",
                    content = @Content(mediaType = "application/json"))
    })
    @PostMapping("/logout")
